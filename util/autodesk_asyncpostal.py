...
LOG_FILENAME = '/Application/bermuda3/logs/autodesk_asyncpostal.log'
# LOG_FILENAME = '/home/rubin/logs/autodesk_asyncpostal.log'
...
class HttpClient(asyncore.dispatcher):
    def __init__(self, host, dev, port, url, read_count=1000, my_map=None,
                 connect_timeout=5, response_timeout=5):
        ...
        self.write_buffer = 'HEAD %s HTTP/1.0\r\n\r\n' % url
    ...
    def readable(self):
        logger.debug('readable host:%s' % self.host)
    ...
    def handle_read(self):
        ...
        # close the connection and do not need too much data , only the header is enough
        self.handle_close()
